    ...
    for filename in os.listdir(yolo_output_dir):
        ...
        if(line1 == line2): #no error
            ...
            if(line1[3] != line2[3]): #xmax do not match (right line eqn)
                ...
                perf[0] = line2[3] #human line
                perf[1] = line1[3] #yolo line
                perf[2] = line1[3]+right_pre[0][0] #ModelB output line
                perf[3] = abs(line1[3]-line2[3]) #YOLO error
                perf[4] = abs(perf[2]-line2[3]) #modelB error
