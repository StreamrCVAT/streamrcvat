...
def bottom_pipeline(YOLO_OUTPUT_DIR, HUMAN_ANNOTATED_DIR, FRAMES_DIR):
    ...
    bottom_model = batch_train("bottom", YOLO_OUTPUT_DIR, HUMAN_ANNOTATED_DIR, FRAMES_DIR)
    ...
    for filename in os.listdir(yolo_output_dir):
        ...
        if(line1 == line2): #no error
            ...
            if(line1[2] != line2[2]): #ymax do not match (bottom line eqn)
                ...
                perf[0] = line2[2] #human line
                perf[1] = line1[2] #yolo line
                perf[2] = line1[2]+bottom_pre[0][0] #ModelB output line
                perf[3] = abs(line1[2]-line2[2]) #YOLO error
                perf[4] = abs(perf[2]-line2[2]) #modelB error
